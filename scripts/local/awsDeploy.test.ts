...
assert.match(dockerfile, /\/app\/node_modules \/app\/node_modules/);
assert.match(dockerfile, /\/app\/artifacts\/api-server\/node_modules \/app\/artifacts\/api-server\/node_modules/);
