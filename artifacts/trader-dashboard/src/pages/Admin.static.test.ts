...
assert.match(adminPage, /AdminLibraryContentManager/);
assert.match(adminPage, /AdminMilestonesContentManager/);
assert.match(adminPage, /TabsTrigger value="library"/);
assert.match(adminPage, /TabsTrigger value="milestones"/);
assert.match(adminPage, /createAdminLibraryContent/);
assert.match(adminPage, /uploadAdminLibraryFile/);
assert.match(adminPage, /updateAdminMilestone/);
assert.match(adminPage, /uploadAdminMilestoneFile/);
